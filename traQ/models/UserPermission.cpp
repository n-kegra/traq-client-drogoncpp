...
UserPermission::UserPermission() { value = Value::Unknown; };
UserPermission::operator Json::Value() const {
    return this->toJson();
}
UserPermission::UserPermission(const Json::Value& __value) {
    this->fromJson(__value);
}
UserPermission::UserPermission(const Value __value) : value(__value) {}
