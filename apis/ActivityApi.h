...
public:
    ...
    ActivityApi& setBearerToken(std::string _token) { this->bearer_token = _token; }
    ActivityApi& setBasicAuth(std::string _username, std::string _password) { this->basic_username = _username; this->basic_password = _password; }
    ActivityApi& setApikey(std::string _apikey) { this->apikey = _apikey; }
