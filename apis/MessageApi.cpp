...
auto MessageApi::addMessageStamp(
...
auto MessageApi::getDirectMessages(
...
auto MessageApi::getMessageClips(
    const std::string& _messageId
){
    auto req = drogon::HttpRequest::newHttpRequest();
    req->setMethod(drogon::HttpMethod::Get);
...
auto MessageApi::getMessageStamps(
    const std::string& _messageId
){
    auto req = drogon::HttpRequest::newHttpRequest();
    req->setMethod(drogon::HttpMethod::Get);
...
auto MessageApi::postDirectMessage(
    const std::string& _userId, 
    const std::optional<PostMessageRequest>& _postMessageRequest
){
    Json::Value json;
...
auto MessageApi::removeMessageStamp(
    const std::string& _messageId, 
    const std::string& _stampId
){
    auto req = drogon::HttpRequest::newHttpRequest();
...
auto MessageApi::searchMessages(
    ...
    if(_word.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "word", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_after.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "after", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_before.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "before", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_in.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "in", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_to.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "to", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_from.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "from", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_citation.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "citation", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_bot.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "bot", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_hasURL.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "hasURL", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_hasAttachments.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "hasAttachments", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_hasImage.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "hasImage", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_hasVideo.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "hasVideo", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_hasAudio.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "hasAudio", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
    ...
    if(_sort.has_value()) {
        ...
        constexpr auto style = Helper::SerializeStyle::form;
        auto serialized_list = Helper::serialize_explode(style, "sort", jsonobj);
        query_strs.assign(serialized_list.begin(), serialized_list.end());
    }
