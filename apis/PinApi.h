...
public:
    ...
    PinApi& setBearerToken(std::string _token) { this->bearer_token = _token; }
    PinApi& setBasicAuth(std::string _username, std::string _password) { this->basic_username = _username; this->basic_password = _password; }
    PinApi& setApikey(std::string _apikey) { this->apikey = _apikey; }
