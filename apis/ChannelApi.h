...
public:
    ...
    ChannelApi& setBearerToken(std::string _token) { this->bearer_token = _token; }
    ChannelApi& setBasicAuth(std::string _username, std::string _password) { this->basic_username = _username; this->basic_password = _password; }
    ChannelApi& setApikey(std::string _apikey) { this->apikey = _apikey; }
    ...
    auto createChannel(
        ...
        if(_postChannelRequest.has_value()) {
            json["postChannelRequest"] = (_postChannelRequest.value());
        }
    ...
    auto editChannel(
        ...
        if(_patchChannelRequest.has_value()) {
            json["patchChannelRequest"] = (_patchChannelRequest.value());
        }
        auto req = drogon::HttpRequest::newHttpJsonRequest(json);
    ...
    auto editChannelTopic(
        ...
        if(_putChannelTopicRequest.has_value()) {
            json["putChannelTopicRequest"] = (_putChannelTopicRequest.value());
        }
        auto req = drogon::HttpRequest::newHttpJsonRequest(json);
