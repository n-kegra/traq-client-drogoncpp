...
public:
    ...
    FileApi& setBearerToken(std::string _token) { this->bearer_token = _token; }
    FileApi& setBasicAuth(std::string _username, std::string _password) { this->basic_username = _username; this->basic_password = _password; }
    FileApi& setApikey(std::string _apikey) { this->apikey = _apikey; }
    ...
    auto deleteFile(
        ...
        
        {
            ...
            auto serialized = Helper::serialize(style, "fileId", jsonobj);
    ...
    auto getFile(
        ...
        if(_dl.has_value()) {
            ...
            auto serialized_list = Helper::serialize_explode(style, "dl", jsonobj);
    ...
    auto getFiles(
        ...
        if(_channelId.has_value()) {
            ...
            constexpr auto style = Helper::SerializeStyle::form;
            auto serialized_list = Helper::serialize_explode(style, "channelId", jsonobj);
            query_strs.assign(serialized_list.begin(), serialized_list.end());
        }
        ...
        if(_mine.has_value()) {
            ...
            constexpr auto style = Helper::SerializeStyle::form;
            auto serialized_list = Helper::serialize_explode(style, "mine", jsonobj);
            query_strs.assign(serialized_list.begin(), serialized_list.end());
        }
