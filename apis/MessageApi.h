...
public:
    ...
    MessageApi& setBearerToken(std::string _token) { this->bearer_token = _token; }
    MessageApi& setBasicAuth(std::string _username, std::string _password) { this->basic_username = _username; this->basic_password = _password; }
    MessageApi& setApikey(std::string _apikey) { this->apikey = _apikey; }
