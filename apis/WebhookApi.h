...
public:
    ...
    WebhookApi& setBearerToken(std::string _token) { this->bearer_token = _token; }
    WebhookApi& setBasicAuth(std::string _username, std::string _password) { this->basic_username = _username; this->basic_password = _password; }
    WebhookApi& setApikey(std::string _apikey) { this->apikey = _apikey; }
    ...
    auto createWebhook(
        ...
        if(_postWebhookRequest.has_value()) {
            json["postWebhookRequest"] = (_postWebhookRequest.value());
        }
    ...
    auto editWebhook(
        ...
        if(_patchWebhookRequest.has_value()) {
            json["patchWebhookRequest"] = (_patchWebhookRequest.value());
        }
        auto req = drogon::HttpRequest::newHttpJsonRequest(json);
