...
public:
    ...
    OgpApi& setBearerToken(std::string _token) { this->bearer_token = _token; }
    OgpApi& setBasicAuth(std::string _username, std::string _password) { this->basic_username = _username; this->basic_password = _password; }
    OgpApi& setApikey(std::string _apikey) { this->apikey = _apikey; }
