...
public:
    ...
    BotApi& setBearerToken(std::string _token) { this->bearer_token = _token; }
    BotApi& setBasicAuth(std::string _username, std::string _password) { this->basic_username = _username; this->basic_password = _password; }
    BotApi& setApikey(std::string _apikey) { this->apikey = _apikey; }
    ...
    auto createBot(
        ...
        if(_postBotRequest.has_value()) {
            json["postBotRequest"] = (_postBotRequest.value());
        }
    ...
    auto editBot(
        ...
        if(_patchBotRequest.has_value()) {
            json["patchBotRequest"] = (_patchBotRequest.value());
        }
        auto req = drogon::HttpRequest::newHttpJsonRequest(json);
    ...
    auto letBotJoinChannel(
        ...
        if(_postBotActionJoinRequest.has_value()) {
            json["postBotActionJoinRequest"] = (_postBotActionJoinRequest.value());
        }
        auto req = drogon::HttpRequest::newHttpJsonRequest(json);
        req->setMethod(drogon::HttpMethod::Post);
    ...
    auto letBotLeaveChannel(
        ...
        if(_postBotActionLeaveRequest.has_value()) {
            json["postBotActionLeaveRequest"] = (_postBotActionLeaveRequest.value());
        }
        auto req = drogon::HttpRequest::newHttpJsonRequest(json);
        req->setMethod(drogon::HttpMethod::Post);
